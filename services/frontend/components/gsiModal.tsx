					...
					<div className="content">
						...
						<ul>
							...
							<li>
								...
								<ul>
									<li>
										Open steam, and right click Dota
										Underlords on the left
									</li>
									<li>
										In the menu you see, click "Manage" and
										then click on "Browse Local Game Files"
									</li>
									<li>
										This should open up a folder on your
										computer. Go into the folder called
										"game"
									</li>
									<li>
									...
									<li>
										Inside the dac folder, go into "cfg"
									</li>
								</ul>
							</li>
							<li>
								Creating gamestate_integration folder and
								placing the file inside it -
								<ul>
									<li>
							...
							<li>
								...
								<ul>
									<li>
										Open up underlords and spectate a
										friend's game if possible (or enter a
										casual game)
									</li>
									<li>
										Wait for a round or two and then go to
										"My Lobby" on the website to check if
										the lobby information has updated
									</li>
									<li>
										It should show entire lobby information
										with their average MMR, if it does not,
										double check the steps written here to
										see if you did everything correctly. If
										it still does not work, please contact
										us and we will resolve the issue for you
									</li>
								</ul>
							</li>
						</ul>
